...
import {
  transportCompanyStartAddNew,
  transportCompanyStartModify,
...
export const TransportCompanyModal = () => {
  ...
  const handleSave = (e) => {
    ...
    if (modalType === modalTypes.new) {
      dispatch(transportCompanyStartAddNew(formValues));
    } else if (modalType === modalTypes.modify) {
      dispatch(transportCompanyStartModify(formValues));
    }
